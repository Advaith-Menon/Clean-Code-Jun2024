...
class Impl : public I
{
    public:
     ...
     void operation() override{ cout<<"Impl Operation"<<endl;}
    ...
    static std::string GetFactoryName() { return "IMPL"; }
    private:
...
bool Impl::registered =

  Factory::Register(Impl::GetFactoryName(),   
